...
public class UserService {
     ...
     */
    @Transactional
    public UserLoginResultDto registerOrUpdateUser(String provider, OAuth2Attributes attributes) {
        return userRepository.findBySocialProviderAndId(provider, attributes.providerId())
                .map(entity -> {
                    ...
                    return new UserLoginResultDto(entity, false);
                })
                .orElseGet(() -> {
                    ...
                    return new UserLoginResultDto(savedUser, true);
                });
    }
}